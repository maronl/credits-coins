...
//$phpunit_wordpress_path = dirname( dirname( __FILE__ ) );

//require_once $phpunit_wordpress_path . '/includes/functions.php';
//function _manually_load_plugin() {

  //  require 'c:/xampp/htdocs/wp-plugin-dev/wordpress/wp-content/plugins/secure-attachments/secure-attachments.php';
  //  require 'c:/xampp/htdocs/wp-plugin-dev/wordpress/wp-content/plugins/credits-coins/credits-coins.php';
...
print_r($GLOBALS['wp_tests_options']);
